...
case 3:
				...
				break;
```
We see the order these classes get instanciated and freed, and we know malloc will allocate by LIFO, that means our payload will get allocated into w first, becasue it's last to be freed.
